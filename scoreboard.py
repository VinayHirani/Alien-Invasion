...
class ScoreBoard():
	...
	def __init__(self , ai_settings , screen , stats):
		...
		#Prep init score image and highscore img.
		self.prep_score()
	...
	def prep_score(self):
		...
		#display the score on the right edge of screen.
	...
	def prep_high_score(self):
		...
		#Center the high score to the top.
	...
	def prep_level(self):
		...
		""" Position the score just below the score on screen"""
